...
func (m *MockStore) GetUserByUsernameOrEmail(ctx context.Context, username string) (db.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) GetUserByUsernameOrEmail(ctx, username interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserByUsernameOrEmail", reflect.TypeOf((*MockStore)(nil).GetUserByUsernameOrEmail), ctx, username)
}
